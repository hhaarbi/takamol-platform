...
export const subscriptionInvoices = mysqlTable("subscription_invoices", {
  ...
  subtotal: decimal("inv_subtotal", { precision: 10, scale: 2 }).notNull().default("0"),
  vatRate: decimal("inv_vat_rate", { precision: 5, scale: 4 }).default("0.1500"),
  vatAmount: decimal("inv_vat_amount", { precision: 10, scale: 2 }).default("0"),
  amount: decimal("inv_amount", { precision: 10, scale: 2 }).notNull(),
  totalWithVat: decimal("inv_total_with_vat", { precision: 10, scale: 2 }).notNull().default("0"),
